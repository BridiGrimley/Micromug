...
class DataSet {
    ...
    let savoury = [
        RecipeCategory(title: "Microwave Mug Pizza", imageName: "Pizzamug", description: "Homemade Pizza made in a microwave in just a few minutes? Oh yes, and it’s INCREDIBLE! My Microwave Mug Pizza recipe is a serious game changer when it comes to your meals, and maybe life (just sayin’). It is real food, fast, and better than fast food. You will simply not believe the results.", method: "1. Mix the flour, baking powder, baking soda and salt together in a microwavable mug.\n 2.Add in the milk and oil then mix together. There might be some lumps but that is ok.\n 3. Spoon on the marinara sauce and spread it around the surface of the batter.\n 4.Sprinkle on the cheese, pepperoni, and dried herbs.\n 5. Microwave for 1 minute 10 - 1 minute 20 seconds, or until it rises up and the toppings are bubbling (timing is based on my 1200W microwave so your timing might vary)", ingredients: "Flour\n salt\n milk"),
        RecipeCategory(title: "Mugrito", imageName: "mugBuritto", description: "One of my favorite savory breakfasts is a Breakfast Burrito. They are filling and full of things I love like eggs and cheese, and wrapped up in a soft white tortilla. To be fair, if you wrapped an old boot in a tortilla I would put salsa on it, so to fill it with some of my breakfast favorites is just a no brainer.", method: "1. In a large microwavable mug press in a fresh tortilla. It will naturally fold into the shape of the mug and find its way.\n2.Crack in your eggs and whisk up with a fork, taking care not to tear the tortilla.\n3. Now add in your favorite burrito mixins like cheese, beans, and scallions. Season with salt and pepper and mix all together. Whatever ingredients you have to hand will work great.\n4. Microwave for 1 minute 20 seconds. Check, and if the eggs are still liquid, cook for another 15 -20 seconds. Keep an eye during cooking so the eggs don’t overheat. You don’t want an egg-splosion in your microwave. The cook time is based on my 1200W microwave so yours might vary.\n5. Once done, let it sit for 3 minutes to cool and serve with some sour cream and salsa on top. I like to eat a little out of the middles and then lift it out of the mug and roll it like a burrito.", ingredients: "large 9 inch tortilla (flour or whole wheat)\n2 eggs\n2 tablespoons beans (pinto/black beans)\n2 tablespoons cheddar cheese , grated\n2 tablespoons scallions , chopped\nsalt and pepper\nGarnish\nsalsa\nSour Cream")
